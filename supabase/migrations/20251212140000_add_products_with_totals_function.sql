-- Create a function that returns products with both store-specific and total quantities
-- This is used for managers/cashiers to see their stock + total stock across all stores
...
GRANT EXECUTE ON FUNCTION public.get_products_with_totals TO authenticated;
